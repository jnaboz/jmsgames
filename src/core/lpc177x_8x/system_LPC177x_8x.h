...
#define NS_2_CLKS(ns) 					(((EMCClock / 1000000000) * ns) + 1)	/* Convert ns to CCLKs */
 ...
 * 
 * See vardef.h
 * __MAIN_OSC_CLK_CFG is used to determine which clock configuration will be used
 * 0: Main PLL setup will be used
 * 1: Main Oscillator setup will be used
 *
 *----------------------------------------------------------------------------*/
...
#else
	#define XTAL        		(16000000UL)        /* Oscillator frequency               */
	#define OSC_CLK     		(48000000UL)    	/* Main oscillator frequency          */
	#define RTC_CLK     		(   32768UL)        /* RTC oscillator frequency           */
	#define IRC_OSC     		(12000000UL)        /* Internal RC oscillator frequency   */
	#define WDT_OSC				(  500000UL)		/* Internal WDT oscillator frequency  */
#endif
