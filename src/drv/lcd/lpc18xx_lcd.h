...
void LCD_Init(LPC_LCD_TypeDef *LCDx, LCD_CFG_Type *LCD_ConfigStruct);
void LCD_DeInit(LPC_LCD_TypeDef *LCDx);

void LCD_Power(LPC_LCD_TypeDef *LCDx, FunctionalState OnOff);
void LCD_Enable(LPC_LCD_TypeDef *LCDx, FunctionalState EnDis);
void LCD_SetFrameBuffer(LPC_LCD_TypeDef *LCDx, void* buffer);
void LCD_SetLPFrameBuffer(LPC_LCD_TypeDef *LCDx, void* buffer);
void LCD_LoadPalette(LPC_LCD_TypeDef *LCDx, void* palette);
void LCD_SetInterrupt(LPC_LCD_TypeDef *LCDx, LCD_INT_SRC Int);
void LCD_ClrInterrupt(LPC_LCD_TypeDef *LCDx, LCD_INT_SRC Int);
LCD_INT_SRC LCD_GetInterrupt(LPC_LCD_TypeDef *LCDx);

void LCD_Cursor_Config(LPC_LCD_TypeDef *LCDx, LCD_CURSOR_SIZE_OPT cursor_size, Bool sync);
void LCD_Cursor_WriteImage(LPC_LCD_TypeDef *LCDx, uint8_t cursor_num, void* Image);
void* LCD_Cursor_GetImageBufferAddress(LPC_LCD_TypeDef *LCDx, uint8_t cursor_num);
void LCD_Cursor_Enable(LPC_LCD_TypeDef *LCDx, uint8_t cursor_num, FunctionalState OnOff);
void LCD_Cursor_LoadPalette0(LPC_LCD_TypeDef *LCDx, uint32_t palette_color);
void LCD_Cursor_LoadPalette1(LPC_LCD_TypeDef *LCDx, uint32_t palette_color);
void LCD_Cursor_SetInterrupt(LPC_LCD_TypeDef *LCDx);
void LCD_Cursor_ClrInterrupt(LPC_LCD_TypeDef *LCDx);
void LCD_Cursor_SetPos(LPC_LCD_TypeDef *LCDx, uint16_t x, uint16_t y);
void LCD_Cursor_SetClipPos(LPC_LCD_TypeDef *LCDx, uint16_t x, uint16_t y);
