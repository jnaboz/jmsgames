...
#include "system_LPC177x_8x.h"
	...
	#define CLKSRCSEL_Val       (0x00000001)
	#define PLL0_SETUP          (1)
	#define PLL0CFG_Val         (0x00000025)
	#define PLL1_SETUP          (0)
	#define PLL1CFG_Val         (0x00000023)
	#define CCLKSEL_Val         ((0x0000002) | (1<<8))
	#define USBCLK_SETUP		(0)
	#define USBCLKSEL_Val       (0x00000001|(0x02<<8))
	#define EMCCLKSEL_Val		(0x00000000)
	#define PCLKSEL_Val      	(0x0000000C)
	#define PCONP_Val           (0x20009060)
	#define CLKOUTCFG_Val       (0x00000100)
#endif
...
void SystemInit (void)
{
  ...
  LPC_SC->PLL0CON   = 0x00000001;             		/* PLL0 Enable                        */
